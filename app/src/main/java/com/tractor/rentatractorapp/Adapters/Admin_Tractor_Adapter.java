...
public class Admin_Tractor_Adapter extends RecyclerView.Adapter<Admin_Tractor_Adapter.viewHolder> {

    ArrayList<Tractor_Models> tractorModelsArrayList;
    ArrayList<Tractor_Models> filteredList;
    Context context;

    public Admin_Tractor_Adapter(ArrayList<Tractor_Models> tractorModelsArrayList, Context context) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.custom_product_items, parent, false);
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        if(tractorModels.getIsAvailable().equals("true")){
            holder.Is_Available.setText("Av");
            ...
            holder.Is_Available.setText("Not Av");
